...
const favorite_song_entity_1 = require("../entities/favorite-song.entity");
...
exports.FavoritesModule = FavoritesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([favorite_song_entity_1.FavoriteSong]), auth_module_1.AuthModule],
